...
class _PrimeiroAcessoPageState extends State<PrimeiroAcessoPage> {
  ...
  Future<Map<String, dynamic>?> _checkIfClientExistsInApp(
    ...
    print(
        "PrimeiroAcesso: Verificando cliente no APP ATUAL com CPF (sem máscara): $unmaskedCpf");
    if (unmaskedCpf.isEmpty) {
      print("PrimeiroAcesso (App Atual): CPF sem máscara está vazio.");
      return null;
    }
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        print(
            "PrimeiroAcesso (App Atual): Cliente encontrado! Doc ID: ${clientDoc.id}");
        return {
          'docId': clientDoc.id,
      ...
      print(
          "PrimeiroAcesso (App Atual): Nenhum cliente encontrado com o CPF $unmaskedCpf no campo 'cpfCnpj'.");
      return null; // Cliente NÃO existe no app atual
    } catch (e) {
      print("PrimeiroAcesso (App Atual): Erro ao verificar cliente: $e");
      return null;
    }
  }
  ...
  Future<void> _register() async {
    ...
    print(
        "PrimeiroAcesso: Iniciando processo para CPF (sem máscara): $unmaskedCpf");
    ...
    try {
      ...
      if (clientDataInApp != null) {
        ...
        print(
            "PrimeiroAcesso: Cliente encontrado no Firestore do app atual. Prosseguindo com criação/vinculação de Auth (usando email do formulário) no app.");
        ...
        print(
            "PrimeiroAcesso: Usuário Auth criado/logado para email do formulário: ${userCredential.user?.email}");
        ...
        print(
            "PrimeiroAcesso: Documento do cliente (existente no app) atualizado com Auth UID e email do formulário.");

        final prefs = await SharedPreferences.getInstance();
        await prefs.setString('clienteDocId', clientDocId);
        await prefs.setString('clienteNome', clientName);
        print(
            "PrimeiroAcesso: Dados salvos localmente. Navegando para o Painel...");
        ...
        print(
            "PrimeiroAcesso: Cliente NÃO encontrado no Firestore do app atual. Tentando importação do painel-agrogeo...");
        ...
        if (dadosClientePainel != null) {
          ...
          print(
              "PrimeiroAcesso: Cliente encontrado no painel-agrogeo. Dados: $dadosClientePainel");
          print(
              "PrimeiroAcesso: Tentando importar cliente para o app atual (Auth com CPF@agrogeo.app e dados no Firestore do app)...");
          ...
          if (importedUserCredential != null &&
            ...
            print(
                "PrimeiroAcesso: Importação bem-sucedida. Usuário Auth: ${importedUserCredential.user!.email}");
            ...
            await prefs.setString('clienteNome', clientName);
            print(
                "PrimeiroAcesso: Dados do cliente importado salvos localmente. Navegando para o Painel...");
            ...
            print(
                "PrimeiroAcesso: Falha ao importar cliente do painel para o app atual.");
            _showErrorSnackbar(
          ...
          print(
              "PrimeiroAcesso: Cliente também NÃO encontrado no painel-agrogeo.");
      ...
      if (e.code == 'weak-password') {
        ...
        print(
            'PrimeiroAcesso: FirebaseAuthException: ${e.code} - ${e.message}');
      }
      _showErrorSnackbar(message);
    } catch (e) {
      print('PrimeiroAcesso: Erro inesperado: $e');
                ...
                children: [
                  ...
                  _isLoading
                      ...
                      : ElevatedButton(
                          ...
                          onPressed: _register,
                          child: const Text(
                              'CRIAR ACESSO'), // Mantido como no original, mas poderia ser 'Criar Acesso'
                        ),
                ],
              ),
            ),
