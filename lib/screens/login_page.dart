...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<Map<String, dynamic>?> _getClientDataByUnmaskedCpf(
    ...
    print("Login: Verificando cliente com CPF (sem máscara): $unmaskedCpf");
    if (unmaskedCpf.isEmpty) {
      print("Login: CPF sem máscara está vazio.");
      return null;
    }
    try {
      ...
      if (querySnapshot.docs.isNotEmpty) {
        ...
        print("Login: Cliente encontrado! Doc ID: ${clientDoc.id}");
      ...
      print(
          "Login: Nenhum cliente encontrado com o CPF $unmaskedCpf no campo 'cpfCnpj'.");
      return null;
    } catch (e) {
      print('Login: Erro ao buscar dados do cliente pelo CPF: $e');
      return null;
    }
  }
  ...
  Future<void> _signIn() async {
    ...
    print("Login: Iniciando login para CPF (sem máscara): $unmaskedCpf");
    ...
    try {
      ...
      if (clientData == null || clientData['email'] == null) {
        print("Login: CPF não encontrado ou sem email associado.");
      ...
      print(
          "Login: Cliente encontrado (Doc ID: $clientDocId, Email: $email). Tentando autenticar no Auth...");
      ...
      print('Login: Erro inesperado no login: $e');
